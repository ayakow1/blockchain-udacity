...
contract FlightSuretyApp {
    ...
    */   
    ...
    function vote 
                            ...
                            external
    {
        flightSuretyData.vote(airline, msg.sender);
    }
    ...
    */  
                        ...
                        returns(uint8)
    {
        ...
        bytes32 okey = keccak256(abi.encodePacked(index, airline, flight, timestamp));
        oracleResponses[okey] = ResponseInfo({
...
contract FlightSuretyData {
    function registerAirline(address airline, string airlinename, address sender) external;
    function vote(address airline, address sender) external;

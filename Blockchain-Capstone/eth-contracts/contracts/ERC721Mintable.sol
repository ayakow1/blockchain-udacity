...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _owner, "address equals to the owner of tokenID");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _owner || isApprovedForAll(_owner, msg.sender), "sender not authorized");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "Not approved owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _owner, "from should be owner");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function createTokenURI(uint256 tokenID) internal {
        require(_exists(tokenID));
        string memory uri = usingOraclize.strConcat(_baseTokenURI ,usingOraclize.uint2str(tokenID));
...
contract CustomERC721Token is ERC721Metadata("Joe's Drawing", "PCT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
